...
namespace e10::commands
{
    ...
    {
        recompile_all_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "RecompileAll", pDataBase) { RegisterArguments(); }
    ...
    {
        recompile_errors_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "RecompileErrors", pDataBase) { RegisterArguments(); }
    ...
    {
        compile_start_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "CompileStart", pDataBase) { RegisterArguments(); }
    ...
    {
        compile_pause_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "CompilePause", pDataBase) { RegisterArguments(); }
    ...
    {
        compile_auto_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "CompileAuto", pDataBase) { RegisterArguments(); }
    ...
    {
        compile_status_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "CompileStatus", pDataBase) { RegisterArguments(); }
