...
namespace e10::commands
{
    ...
    {
        source_control_status_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "SourceControlStatus", pDataBase) { RegisterArguments(); }
    ...
    {
        source_control_depot_status_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "SourceControlDepotStatus", pDataBase) { RegisterArguments(); }
    ...
    {
        source_control_refresh_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "SourceControlRefresh", pDataBase) { RegisterArguments(); }
    ...
    {
        source_control_list_locks_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "SourceControlListLocks", pDataBase) { RegisterArguments(); }
    ...
    {
        source_control_pull_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "SourceControlPull", pDataBase) { RegisterArguments(); }
        ...
        std::string Query() noexcept override
        {
            ...
            if (Result.succeeded)
            {
                // A pull can change a Script-Module's sources exactly like a local edit; the editor decides what to reload.
                if (auto* pHost = xeditor::host::current(); pHost && pHost->m_OnSourceChanged) pHost->m_OnSourceChanged();
    ...
    {
        source_control_push_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "SourceControlPush", pDataBase) { RegisterArguments(); }
