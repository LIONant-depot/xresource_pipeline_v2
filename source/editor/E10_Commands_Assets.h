...
namespace e10::commands
{
    ...
    {
        list_assets_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "ListAssets", pDataBase) { RegisterArguments(); }
    ...
    {
        describe_asset_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "DescribeAsset", pDataBase) { RegisterArguments(); }
    ...
    struct rename_asset_cmd : xundo::command_base
    {
        ...
        void BackupCurrenState(xundo::undo_file& File) noexcept override
        {
            ...
            File.Write(Library);
            xeditor::WriteString(File, Asset);
    ...
    {
        move_asset_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::command_base(System, "MoveAsset", pDataBase) { RegisterArguments(); }
        ...
        void BackupCurrenState(xundo::undo_file& File) noexcept override
        {
            ...
            xeditor::WriteString(File, std::holds_alternative<xerr>(OldParentArg) ? std::string(32, '0') : std::get<std::string>(OldParentArg));
            xeditor::WriteString(File, std::holds_alternative<xerr>(NewParentArg) ? std::string(32, '0') : std::get<std::string>(NewParentArg));
        }
    ...
    {
        delete_asset_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::command_base(System, "DeleteAsset", pDataBase) { RegisterArguments(); }
        ...
        void BackupCurrenState(xundo::undo_file& File) noexcept override
        {
            ...
            xeditor::WriteString(File, OldParent);
        }
    ...
    {
        restore_asset_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::command_base(System, "RestoreAsset", pDataBase) { RegisterArguments(); }
    ...
    {
        save_assets_query_cmd(xundo::system& System, void* pDataBase) noexcept : xundo::query_command_base(System, "SaveAssets", pDataBase) { RegisterArguments(); }
